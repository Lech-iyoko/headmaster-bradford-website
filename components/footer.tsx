        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link href="#reviews" className="text-sm text-background/70 hover:text-background transition-colors">
                Reviews
              </Link>
          ...
          {/* Hours */}
          <div>
            <h3 className="font-semibold text-background mb-4">Opening Hours</h3>
            <div className="flex items-start gap-3">
              <Clock className="w-4 h-4 mt-0.5 text-background/70" />
